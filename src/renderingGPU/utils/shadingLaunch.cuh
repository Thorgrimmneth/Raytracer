                                              ...
                                              int offset, int activeCount, int depth)
{
    shadeLambertKernel<<<gridForCount(activeCount), block1D>>>(
        ...
        in.hitNormals + offset, in.hitMaterialIndices + offset, in.pixelIndices + offset, out.origins,
        out.directions, out.throughputs, out.pixelIndices, out.lastBounceWasDelta,
                                            ...
                                            int offset, int activeCount, int depth)
{
    shadeMetalKernel<<<gridForCount(activeCount), block1D>>>(
        scene, in.directions + offset, in.throughputs + offset, in.rng + offset, in.hitPositions + offset,
        in.hitNormals + offset, in.hitMaterialIndices + offset, in.pixelIndices + offset, accumBuffer,
        out.origins, out.directions, out.throughputs, out.pixelIndices,
        out.lastBounceWasDelta, out.lastBsdfPdf, out.isInside, out.rng,
        out.activeCount, activeCount, depth);
}
                                              ...
                                              int offset, int activeCount, int depth)
{
    shadePlasticNEEKernel<<<gridForCount(activeCount), block1D>>>(
        ...
        scene.lightCumulativeWeights, activeCount);
...
void launchShadeKernel<MaterialType::TRANSPARENT>(SortedRayQueue &in, RayQueue &out, CudaScene scene,
                                                  float3 *accumBuffer, int offset, int activeCount, int depth)
{
    shadeTransparentKernel<<<gridForCount(activeCount), block1D>>>(
        ...
        accumBuffer, out.origins, out.directions, out.throughputs, out.pixelIndices,
        out.lastBounceWasDelta, out.lastBsdfPdf, out.isInside, out.rng,
        out.activeCount, activeCount, depth);
}
                       ...
                       int offset, int activeCount, int depth)
{
    ...
    case MaterialType::MISS:
        launchShadeKernel<MaterialType::MISS>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;
    case MaterialType::LAMBERT:
        launchShadeKernel<MaterialType::LAMBERT>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;

    case MaterialType::METAL:
        launchShadeKernel<MaterialType::METAL>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;

    case MaterialType::PLASTIC:
        launchShadeKernel<MaterialType::PLASTIC>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;
    case MaterialType::MIRROR:
        launchShadeKernel<MaterialType::MIRROR>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;
    case MaterialType::TRANSPARENT:
        launchShadeKernel<MaterialType::TRANSPARENT>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;
    case MaterialType::EMISSIVE:
        launchShadeKernel<MaterialType::EMISSIVE>(in, out, scene, accumBuffer, offset, activeCount, depth);
        break;
